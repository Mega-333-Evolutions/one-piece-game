...
SHOULD_LOG_TIMER_TEMP_DIR_CLEANUP = Environment(
    "SHOULD_LOG_TIMER_TEMP_DIR_CLEANUP", default_value="True"
)
...
SHOULD_LOG_TIMER_SEND_LEADERBOARD = Environment(
    "SHOULD_LOG_TIMER_SEND_LEADERBOARD", default_value="True"
)
...
SHOULD_LOG_TIMER_RESET_BOUNTY_POSTER_LIMIT = Environment(
    "SHOULD_LOG_TIMER_RESET_BOUNTY_POSTER_LIMIT", default_value="True"
)
...
SHOULD_LOG_TIMER_RESET_CAN_CHANGE_REGION = Environment(
    "SHOULD_LOG_TIMER_RESET_CAN_CHANGE_REGION", default_value="True"
)
...
SHOULD_LOG_TIMER_ADD_REGION_BOUNTY_BONUS = Environment(
    "SHOULD_LOG_TIMER_ADD_REGION_BOUNTY_BONUS", default_value="True"
)
...
SHOULD_LOG_TIMER_ADD_CREW_BOUNTY_BONUS = Environment(
    "SHOULD_LOG_TIMER_ADD_CREW_BOUNTY_BONUS", default_value="True"
)
...
SHOULD_LOG_TIMER_ADD_CREW_MVP_BOUNTY_BONUS = Environment(
    "SHOULD_LOG_TIMER_ADD_CREW_MVP_BOUNTY_BONUS", default_value="True"
)
...
SHOULD_LOG_TIMER_DAILY_REWARD = Environment("SHOULD_LOG_TIMER_DAILY_REWARD", default_value="True")
...
SHOULD_LOG_TIMER_RESET_BOUNTY_MESSAGE_LIMIT = Environment(
    "SHOULD_LOG_TIMER_RESET_BOUNTY_MESSAGE_LIMIT", default_value="True"
)
...
SHOULD_LOG_TIMER_REDDIT_POST_ONE_PIECE = Environment(
    "SHOULD_LOG_TIMER_REDDIT_POST_ONE_PIECE", default_value="True"
)
...
SHOULD_LOG_TIMER_REDDIT_POST_MEME_PIECE = Environment(
    "SHOULD_LOG_TIMER_REDDIT_POST_MEME_PIECE", default_value="True"
)
...
SHOULD_LOG_TIMER_SEND_SCHEDULED_PREDICTIONS = Environment(
    "SHOULD_LOG_TIMER_SEND_SCHEDULED_PREDICTIONS", default_value="True"
)
...
SHOULD_LOG_TIMER_CLOSE_SCHEDULED_PREDICTIONS = Environment(
    "SHOULD_LOG_TIMER_CLOSE_SCHEDULED_PREDICTIONS", default_value="True"
)
...
SHOULD_LOG_TIMER_REFRESH_ACTIVE_PREDICTIONS_GROUP_MESSAGE = Environment(
    "SHOULD_LOG_TIMER_REFRESH_ACTIVE_PREDICTIONS_GROUP_MESSAGE", default_value="True"
)
...
SHOULD_LOG_TIMER_SCHEDULE_DEVIL_FRUIT_ZOAN_RELEASE = Environment(
    "SHOULD_LOG_TIMER_SCHEDULE_DEVIL_FRUIT_ZOAN_RELEASE", default_value="True"
)
...
SHOULD_LOG_TIMER_RESPAWN_DEVIL_FRUIT = Environment(
    "SHOULD_LOG_TIMER_RESPAWN_DEVIL_FRUIT", default_value="True"
)
...
SHOULD_LOG_TIMER_DEACTIVATE_INACTIVE_GROUP_CHATS = Environment(
    "SHOULD_LOG_TIMER_DEACTIVATE_INACTIVE_GROUP_CHATS", default_value="True"
)
...
SHOULD_LOG_TIMER_END_INACTIVE_GAMES = Environment(
    "SHOULD_LOG_TIMER_END_INACTIVE_GAMES", default_value="True"
)
...
SHOULD_LOG_TIMER_SET_EXPIRED_BOUNTY_LOANS = Environment(
    "SHOULD_LOG_TIMER_SET_EXPIRED_BOUNTY_LOANS", default_value="True"
)
...
SHOULD_LOG_TIMER_FIGHT_PLUNDER_SCOUT_COUNT_DECREASE = Environment(
    "SHOULD_LOG_TIMER_FIGHT_PLUNDER_SCOUT_COUNT_DECREASE", default_value="True"
)
...
SHOULD_LOG_TIMER_MINUTE_TASKS = Environment("SHOULD_LOG_TIMER_MINUTE_TASKS", default_value="True")
